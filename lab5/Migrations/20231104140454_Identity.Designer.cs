...
namespace lab5.Migrations
{
    ...
    [Migration("20231104140454_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lab5.Models.AgentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lab5.Models.Contract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lab5.Models.InsuranceAgent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lab5.Models.InsuranceAgent", b =>
                {
                    b.HasOne("lab5.Models.AgentType", "AgentType")
                        .WithMany("InsuranceAgents")
                        .HasForeignKey("AgentTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("lab5.Models.Contract", "Contract")
                        .WithMany("InsuranceAgents")
